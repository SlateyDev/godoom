...
void G_DoLoadGame (void) 
{
    ...
    save_stream = _fsopen(savename, "rb", _SH_DENYWR);
...
{ 
    ...
    save_stream = _fsopen(temp_savegame_file, "wb", _SH_DENYWR);
    ...
    if (save_stream == NULL)
    {
        ...
        save_stream = _fsopen(recovery_savegame_file, "wb", _SH_DENYWR);
        if (save_stream == NULL)
        {
